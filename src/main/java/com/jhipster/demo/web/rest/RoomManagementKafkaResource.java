...
@RestController
@RequestMapping("/api/room-management-kafka")
public class RoomManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RoomManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RoomManagementKafkaResource(KafkaProperties kafkaProperties) {
